                                        ...
                                        if (file_exists($directory_path)) {
                                            ...
                                            if ($count_sc_file > 2) {
                                                ...
                                                for ($i = 2; $i < $count_sc_file; $i++) {
                                                    ...
                                                    if (is_dir($directory_path . '/' . $sc[$i])) {

                                                        if(file_exists($directory_path . '/' . $sc[$i])){
                                                    ...
                                                    } elseif(is_file($directory_path . '/' . $sc[$i])) {
                                                    unlink($directory_path . '/' . $sc[$i]);
...
<?php
                                        ...
                                        ?>
                                        <div class="upload_files mt-5 pt-5 <?php 
                                    
                                    if($direc_not_avail_error = 1){
                                        echo 'd-none';
                                    }
