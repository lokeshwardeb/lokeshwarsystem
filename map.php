...
<html>
  <head>
    ...
    <script>
      const CONFIGURATION = {
        ...
        "mapsApiKey": "AIzaSyBW6nqwZDxX9Y-OzSXpyDkjBO_DKKG1Np4",
  ...
  <body>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBW6nqwZDxX9Y-OzSXpyDkjBO_DKKG1Np4&callback=initMap&libraries=places,geometry&solution_channel=GMP_QB_locatorplus_v6_cABDF" async defer></script>
  </body>
</html>